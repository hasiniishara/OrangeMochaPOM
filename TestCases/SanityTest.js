...
describe('Sanity Test', () => {
    ...
    describe('Login to the Admin Module', () => {
        //Checking successful login to the Admin Module.
        ...
        //Checking Add new job title to the system.
        it('Should adding new job title in successfullt to the Job section', async () =>{
            //Click Side Bar Admin Module.
            await dashboardPage.clickAdminModule();
